...
class RandomGraphAnalysis():
  ...
  def random_graph_list(self):
    ...
    print("random graph ensemble 생성에 사용 가능한 무작위 그래프는 다음과 같습니다: ER, configuration, chunglu")
  ...
  def create_config_graph(self):
    ...
    if len(self.degree_seq)%2 == 1:
      raise ValueError("차수의 개수는 짝수여야 합니다.")
